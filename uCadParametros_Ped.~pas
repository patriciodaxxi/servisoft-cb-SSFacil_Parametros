...
var
  frmParametros_Ped: TfrmParametros_Ped;
...
procedure TfrmParametros_Ped.btnAlterarClick(Sender: TObject);
begin
...
procedure TfrmParametros_Ped.FormShow(Sender: TObject);
begin
...
procedure TfrmParametros_Ped.FormDestroy(Sender: TObject);
begin
