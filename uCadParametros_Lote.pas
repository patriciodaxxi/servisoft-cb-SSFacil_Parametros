...
begin
  ...
  fDMCadparametros.qParametros_Usuario.Close;
  fDMCadparametros.qParametros_Usuario.ParamByName('USUARIO').AsString := vUsuario;
  fDMCadparametros.qParametros_Usuario.Open;
  dbckGerar_Mat_Por_Lote.Visible := (fDMCadparametros.qParametros_UsuarioPERMITE_ALT_LOTE_MAT.AsString = 'S');
  prc_Opcao_Textil;
end;
